...
void initializeDefaultScene (out STriangle triangles[12], out SSphere spheres[2], out SCube cube) // сцена по умолчанию
{
	...
	spheres[0].Center = vec3(0.75,-1.0,-0.5);  
...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[8]) //материалы по умолчанию
{
	...
	materials[0].Color = vec3(0.7, 0.75, 0.0);   
	...
	materials[2].Color = vec3(0.5, 0.25, 1.0);  
	...
	materials[4].Color = vec3(0.0, 1.0, 0.5);  
